                ...
                <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12">
                    ...
                    <section class="default-section blog-section pt-0 pb-0">
                        <div class="row clearfix">
                            ...
                            <form:form action="${pageContext.request.contextPath}/blog/paint" method="post" modelAttribute="post" commandName="timeline">

                                <table>
                                    <tr>
                                <c:forEach var="blog" items="${misposts}" varStatus="i">
                                    <!--Blog Post-->
                                    <div class="col-md-6 col-sm-6 col-xs-12 featured-blog-post wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                                        <article class="inner-box hvr-float-shadow">
                                            <%--<form:label path="id">${blog.id}</form:label>--%>
                                            <figure class="image">
                                            ...
                                            <div class="post-lower">
                                                  <div class="post-header">
                                                    ...
                                                    <h3 class="title">${blog.description}</h3>
                                                          <%--<input type="text" name="user" value="${blog[i.index].user}"  />--%>
                                                          <input type="text" name="user" value="${blog.user}"  />
                                                    <%--<form:input path="user" name="user" />--%>
                                                    <ul class="post-info">
